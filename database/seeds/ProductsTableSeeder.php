...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert(['name' => 'Yukata', 'title' => 'Yukata','description' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna','price' => 60,'category_id' => 2,'brand_id' => 2,]);
    }
}
