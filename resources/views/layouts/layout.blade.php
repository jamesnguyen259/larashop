...
<html lang="en">
    <head>
        ...
        <title>E-Shopper - Shopping online website</title>
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> +841633391445</a></li>
                                    <li><a href="#"><i class="fa fa-envelope"></i> frankierockie259@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="pull-right">Laravel product by <span><a target="_blank" href="http://www.facebook.com/jamesnguyen259">James Nguyen</a></span> |  Designed by <span><a target="_blank" href="http://www.themeum.com">Themeum</a></span></p>
                    </div>
                </div>
            </div>
